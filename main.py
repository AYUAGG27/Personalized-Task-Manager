...
def signup():
	...
	print("Mam please proceed towards log in")
	login()
...
def login():
	...
	try:
		...
		if pssd_wr == k:
			...
			print("MAM YOUR PASSWORD OR USERNAME IS WRONG")
			login()
...
def task_information(username):
	print("Mam enter no. of task you want to ADD")
	j = int(input())
	f1 = open(username, 'a')
	...
	for i in range(1, j+1):
		...
		f1.write(target)
		f1.write('\n')
		print("Do u want to stop press space bar otherwise enter..... Thankyou")
		s = input()
		if s == ' ':
			break
	f1.close()
...
if __name__ == '__main__':
	print("Welcome TO Ayushi`S TASK MANAGER")
